...
public final class ResultsToComputeId {
    ...
    public static final long computeClassLabelsId         = 0x0000000000000001L;
    public static final long computeIndicesOfNeightborsId = 0x0000000000000002L;
    public static final long computeDistancesId           = 0x0000000000000004L;

    public static final ResultsToComputeId computeClassLabels         = new ResultsToComputeId(computeClassLabelsId);
